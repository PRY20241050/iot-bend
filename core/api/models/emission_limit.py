...
class EmissionLimit(models.Model):
    ...
    is_default = models.BooleanField(default=False, verbose_name='Predeterminado', help_text='Este límite de emisión es el predeterminado')

    institution = models.ForeignKey('api.Institution', on_delete=models.CASCADE, blank=True, null=True, verbose_name='Institución')
    management = models.ForeignKey('api.Management', on_delete=models.CASCADE, blank=True, null=True, verbose_name='Administración')
