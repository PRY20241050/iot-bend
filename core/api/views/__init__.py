...
from .sensor_view import SensorListCreateView, SensorRetrieveUpdateDestroyView, SensorsByDeviceView, SensorLastMeasurementView
from .measurement_view import StatusListCreateView, StatusRetrieveUpdateDestroyView, MeasurementListView, MeasurementRetrieveUpdateDestroyView, MeasurementBySensorView, MeasurementCreateView, MeasurementPaginatedListView
